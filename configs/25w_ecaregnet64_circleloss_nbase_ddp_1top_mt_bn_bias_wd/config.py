...
optimizer = dict(type='SGD', lr=0.1 * len(base_model_ranks)/512*batch_size, momentum=0.9, weight_decay=0.0001, bn_bias_wd=True)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/25w_ecaregnet64_circleloss_nbase_1top_243_248_251_bnbiaswd'
