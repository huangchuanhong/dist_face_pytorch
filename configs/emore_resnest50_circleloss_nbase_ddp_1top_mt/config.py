...
top_model_gpus = [6]
batch_size = 96 * len(base_model_gpus) #512 #736#640
feature_dim = 192
model = dict(
  type='FaceModel',
...
checkpoint_config = dict(interval=200) # step, not epoch
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/emore_resnest50_r2k1_amsoftmax_ndevice_246'
