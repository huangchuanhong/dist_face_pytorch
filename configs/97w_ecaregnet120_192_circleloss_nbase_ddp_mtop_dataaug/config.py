...
optimizer = dict(type='SGD', lr=0.1 * batch_size / 512 * len(base_model_ranks), momentum=0.9, weight_decay=0.00005, bn_bias_wd=False)
...
load_from = None#'/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet64_circleloss_nbase_1top_mt_249_248_251/epoch_8_iter_59222.pth'
