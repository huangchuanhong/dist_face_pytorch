...
optimizer = dict(type='SGD', lr=0.05 * len(base_model_ranks), momentum=0.9, weight_decay=0.00005)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet64_circleloss_nbase_1top_mt_243_248_251_dataaug'
load_from = None#'/mnt/data4/huangchuanhong/code/dist_face_pytorch/checkpoints/25w_ecaregnet64.pth'#'/mnt/data4/huangchuanhong/code/dist_face_pytorch/work_dirs/softmax/latest.pth'
resume_from = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet64_circleloss_nbase_1top_mt_249_248_251/epoch_3_iter_35777.pth' 
