...
optimizer = dict(type='SGD', lr=0.1 * len(base_model_ranks), momentum=0.9, weight_decay=0.)#0.0001)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/25w_regnet64_circleloss_nbase_1top_mt_249_244_245_246'
