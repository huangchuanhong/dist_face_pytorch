...
top_model_gpus = [6]
batch_size = 64 * 3 * len(base_model_gpus) #512 #736#640
feature_dim = 192
model = dict(
  type='FaceModel',
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/emore_mobilefacenet_amsoftmax_ndevice_251_notallparamswd'
