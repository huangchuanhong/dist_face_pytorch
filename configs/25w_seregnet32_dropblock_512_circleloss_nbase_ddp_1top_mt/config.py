...
optimizer = dict(type='SGD', lr=0.1 * batch_size / 512 * len(base_model_ranks), momentum=0.9, weight_decay=0.0001)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/25w_dropblock_seregnet32_512_circleloss_nbase_1top_mt_248_249_251'
load_from = 
