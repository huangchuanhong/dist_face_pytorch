...
optimizer = dict(type='SGD', lr=0.05 * len(base_model_ranks), momentum=0.9, weight_decay=0.00005, bn_bias_wd=True)#False)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet64_512_circleloss_nbase_1top_mt_249_246_245'
