...
optimizer = dict(type='SGD', lr=0.05 * len(base_model_ranks), momentum=0.9, weight_decay=0.0001)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_regnetp_amsoftmax_nbase_1top_mt_244_243_248_251_25w'
