...
optimizer = dict(type='SGD', lr=0.1 * batch_size / 512., momentum=0.9, weight_decay=0.0001, bn_bias_wd=False)
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/emore_ecaregnet64_amsoftmax_ndevice_251_bn_bias_wo_wd'
