...
base_model_ranks = [1,2,3,4,5]
top_model_rank = 0
batch_size = 256 #736#640
feature_dim = 192
model = dict(
...
optimizer = dict(type='SGD', lr=0.1 * len(base_model_ranks), momentum=0.9, weight_decay=0.00005)
...
total_epochs = 7
log_level = 'INFO'
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet120_192_nbase_mtop_dataaug'
