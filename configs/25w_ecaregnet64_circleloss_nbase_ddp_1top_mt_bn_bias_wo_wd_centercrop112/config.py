...
top_model_rank = 0
batch_size = 48 * len(base_model_gpus) #736#640
feature_dim = 192
model = dict(
...
optimizer = dict(type='SGD', lr=0.1 * len(base_model_ranks)/512*batch_size, momentum=0.9, weight_decay=0.0001, bn_bias_wd=False)
...
lr_config = dict(
    ...
    step=[2,4,6,7],
    warmup='linear',
    warmup_iters=data['train_num_samples'] // batch_size // len(base_model_ranks),
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/25w_ecaregnet64_circleloss_nbase_1top_243_248_251_bnbiaswowd_centercrop112'
...
load_top = False
resume_from = None#'/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/97w_ecaregnet64_circleloss_nbase_1top_mt_249_248_251/epoch_3_iter_35777.pth' 
