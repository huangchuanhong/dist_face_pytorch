...
top_model_gpus = [1]
batch_size = 32 * len(base_model_gpus) #512 #736#640
feature_dim = 192
model = dict(
  type='FaceModel',
...
work_dir = '/mnt/data1/huangchuanhong/checkpoints/dist_face_pytorch/work_dirs/emore_eca_dla_amsoftmax_ndevice_36'
