...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, embedding_size=192, num_group=32):
        self.inplanes = 64
        ...
        self.gdc = nn.Conv2d(512 * block.expansion, out_channels=512 * block.expansion,
                             kernel_size=7, groups=512 * block.expansion, stride=1,
                              padding=0, bias=False)
        self.gdc_bn = nn.BatchNorm2d(512 * block.expansion)
