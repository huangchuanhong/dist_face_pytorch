...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        # if dropblock:
        #     self.dropblock4 = DropBlock2D(1 - dropblock_prob, block_size, schedule_step)
        self.stride = stride
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            ...
            # if self.dropblock:
            #     identity = self.dropblock4(identity)
...
class DropBlockedSERegNet(nn.Module):
    """RegNet backbone.
    ...
    def __init__(self,
        ...
        super(DropBlockedSERegNet, self).__init__()
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            if self.dropblock and i in dropblock_stages:
                dropblock_i = True
            else:
                dropblock_i = False
